 ...
 */
public class ToolbarHidingOnScrollListenerrrrrrrrrrrrrr extends RecyclerView.OnScrollListener {
    ...
    public ToolbarHidingOnScrollListenerrrrrrrrrrrrrr(View toolbarContainer, View toolbar, View lastToolbarView) {
        this(toolbarContainer, toolbar, lastToolbarView, null);
    }

    public ToolbarHidingOnScrollListenerrrrrrrrrrrrrr(View toolbarContainer, View toolbar, View lastToolbarView, View parallaxScrollingView) {
